         ...
         <div class="col-sm-6">
            <ol class="breadcrumb my-0 ms-2">
               ...
               <li class="breadcrumb-item active">
                  <span><i class="fas fa-file-alt"></i> Organizer</span>
               </li>
            </ol>
         </div>
         <!-- /.col -->
         ...
         <div class="col-md-12">
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mb-0">Organizer</h4>
                    <div>
                        <a href="{{ route('subscriber.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Add More</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <td>
                                       <div class="btn-group">
                                          ...
                                          <div class="dropdown-menu">
                                             <a href="{{ route('subscriber.edit', $data->id) }}" class="dropdown-item"><i class="fas fa-download"></i> Edit</a>
                                             <form id="deleteForm{{$data->id}}" method="POST" action="{{ route('subscriber.destroy', [$data->id]) }}">
                                                @csrf
                                                @method('delete')
