               ...
               <div class="card card-primary">
                  <div class="card-header">
                     <div class="d-flex justify-content-between">
                        ...
                        <div>
                           <a href="{{ route('subscriber.index') }}" class="btn btn-success btn-sm"><i class="fas fa-eye"></i> View ALL</a>
                        </div>
                     </div>
                  </div>
                  <div class="card-body">
                     ...
                     @endif
                     <form method="POST" action="{{ route('subscriber.store') }}" class="needs-validation" novalidate enctype="multipart/form-data">
                        @csrf
