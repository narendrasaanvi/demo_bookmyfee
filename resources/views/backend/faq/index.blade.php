         ...
         <div class="col-md-12">
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('faqs.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Add More</a>
                    </div>
                </div>
            </div>  
                                    ...
                                    <td>
                                       <div class="btn-group">
                                          ...
                                          <div class="dropdown-menu">
                                             <a href="{{ route('faqs.edit', $data->id) }}" class="dropdown-item"><i class="fas fa-download"></i> Edit</a>
                                             <form id="deleteForm{{$data->id}}" method="POST" action="{{ route('faqs.destroy', [$data->id]) }}">
                                                @csrf
                                                @method('delete')
