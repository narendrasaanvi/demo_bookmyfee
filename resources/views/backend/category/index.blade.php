         ...
         <div class="col-md-12">
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('category.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Add More</a>
                    </div>
                </div>
            </div>  
                                    ...
                                    <td>
                                       <div class="btn-group">
                                          ...
                                          <div class="dropdown-menu">
                                             <a href="{{ route('category.edit', $data->id) }}" class="dropdown-item"><i class="fas fa-download"></i> Edit</a>
                                             <form id="deleteForm{{$data->id}}" method="POST" action="{{ route('category.destroy', [$data->id]) }}">
                                                @csrf
                                                @method('delete')
