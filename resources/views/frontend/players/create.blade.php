...
<section class="header-padding">
   <div class="container py-3">
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            <div class="card p-2">
               <h3 class="text-center mb-4">PLAYER DATA FORM</h3>
               @if ($errors->any())
               ...
               <form action="{{ route('player.registration.store') }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                  @csrf
                  <input type="hidden" name="slug" value="{{$slug}}">
                  <div class="row">
                     <div class="col-md-4 mb-3">
                        <label for="player_name" class="form-label">Player Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('player_name') is-invalid @enderror" value="{{ old('player_name') }}" name="player_name">
                        @error('player_name')
                     ...
                     <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control" id="dob" name="dob" placeholder="dd-mm-yyyy" value="{{ old('dob') }}" required max="{{ date('Y-m-d') }}">
                    </div>
                     <div class="col-md-4 mb-3">
                     ...
                     <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="school_college_name" name="school_college_name"  value="{{ old('school_college_name') }}" required>
                     </div>
                     <div class="col-md-6 mb-3">
                        <label for="fide_rating" class="form-label">FIDE Rating <span class="text-secondary">(if any)</span></label>
                        <input type="text" class="form-control" id="fide_rating" name="fide_rating" value="{{ old('fide_rating') }}">
                     </div>
                     <div class="col-md-4 mb-3">
                        <label for="fide_id" class="form-label">FIDE ID <span class="text-secondary">(required for Rating Event)</span></label>
                        <input type="text" class="form-control @error('fide_id') is-invalid @enderror" id="fide_id" name="fide_id"  value="{{ old('fide_id') }}">
                        @error('fide_id')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                     </div>
                     <div class="col-md-4 mb-3">
                        <label for="aicf_id" class="form-label">AICF ID <span class="text-secondary">(required for Rating Event)</span></label>
                        <input type="text" class="form-control @error('aicf_id') is-invalid @enderror" id="aicf_id" name="aicf_id" value="{{ old('aicf_id') }}">
                        @error('aicf_id')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                     </div>
                     <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="state_membership_id" name="state_membership_id" value="{{ old('state_membership_id') }}" >
                     </div>
                     <div class="col-md-4 mb-3">
                        <label for="mobile_1" class="form-label">Mobile Number <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="mobile_1" name="mobile_1" value="{{ old('mobile_1') }}" required>
                     </div>
                     <div class="col-md-4 mb-3">
                        <label for="mobile_2" class="form-label">Alternate Mobile Number. <span class="text-secondary">(Optional)</span></label>
                        <input type="text" class="form-control" id="mobile_2" name="mobile_2" value="{{ old('mobile_2') }}">
                     </div>
                     <div class="col-md-4 mb-3">
                        <label for="mail_id" class="form-label">Mail ID <span class="text-danger">*</span></label>
                        <input type="email" class="form-control" id="mail_id" name="email" value="{{ old('email') }}"required>
                     </div>
                     ...
                     <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" id="residential_address" name="residential_address"  rows="5"  required>{{ old('residential_address') }}</textarea>
                     </div>
                     <div class="col-md-4 mb-3">
                     ...
                     <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="online_chess_id" value="{{ old('online_chess_id') }}" name="online_chess_id">
                     </div>
                     <div class="col-md-6 mb-3">
                     ...
                     <div class="col-md-12 mb-3">
                        <div class="form-check">
                           ...
                           I agree to the <a href="{{ url('privacy-policy') }}" target="_blank">Terms and Conditions</a> <span class="text-danger">*</span>
                           </label>
                           @error('terms')
                           <div class="invalid-feedback">{{ $message }}</div>
                           @enderror
